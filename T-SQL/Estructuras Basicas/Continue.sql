...
-- CONTINUE permite omitir el resto del codigo dentro del ciclo actual
-- y continuar directamente con la siguiente iteracion del bucle WHILE.
...
BEGIN
    ...
    BEGIN
        ...
        CONTINUE -- Omitir los multiplos de 5
    END
...
PRINT 'La suma de los numeros del 1 al 20, excepto los multiplos de 5, es: ' + CAST(@suma AS VARCHAR(6))
GO


-- Ejercicio Propuesto
/*
Escribe un script que multiplique los numeros del 1 al 10,
